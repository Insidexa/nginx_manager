...
QT_MOC_LITERAL(1, 5, 6), // "msbBox"
QT_MOC_LITERAL(2, 12, 0), // ""
QT_MOC_LITERAL(3, 13, 4) // "host"

    },
    "Host\0msbBox\0\0host"
};
...
void Host::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->msbBox((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Host::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Host::msbBox)) {
                *result = 0;
            }
        }
    }
